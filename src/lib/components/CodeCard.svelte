...
<div>
  <div class="bg-zinc-900 rounded-lg overflow-x-auto border">
    <div class="flex justify-between items-center px-4 py-2 border-b border-zinc-800 bg-zinc-950/50">
    ...
    <div class="border-t border-zinc-800 mt-2">
      <div class="text-xs text-zinc-400 bg-zinc-950/50 px-4 py-2 border-b">Output:</div>
      <div class="px-4 py-4 text-sm">
        <span class="text-green-500">davidref</span>
        <span class="text-white">></span>
        <span class="text-zinc-300"> hello</span>
      </div>
    </div>
  </div>
</div>
